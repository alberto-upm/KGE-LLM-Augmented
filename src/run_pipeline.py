...
def run_phase3(top_k=None, kge_model=None):
    from src.phase3_link_prediction import run
...
def run_create_incident(kge_model=None, llm_model=None, no_llm=False, top_k=5):
    from src.phase4_incident_creator import run
    run(
